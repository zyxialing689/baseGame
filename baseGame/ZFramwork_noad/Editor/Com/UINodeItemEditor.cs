...
[CustomEditor(typeof(UINodeItem))]
public class UINodeItemEditor : Editor
{
    UINodeItem _target;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("更新脚本"))
        {
            ...
            ScriptCreater.CreateItemClassName(path,name,Selection.activeGameObject.GetComponent<UINodeItem>());
        }
